...
export default {
  ...
  data() {
    return {
      ...
      todos: [
        {
          id: 1,
          title: "Finish vue tutorial",
          completed: false,
          editing: false
        },
        {
          id: 2,
          title: "Finish angular tutorial",
          completed: false,
          editing: false
        }
      ]
  ...
  created() {
    ...
    window.eventBus.$on("checkAllChanged", this.checkAllTodos);
  ...
  beforeDestroy() {
    ...
    window.eventBus.$off("checkAllChanged", this.checkAllTodos);
